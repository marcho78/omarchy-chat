...
// Phosphor icon names -> glyphs, generated from fonts/phosphor-regular.css
// by scripts/gen-icons.py. Do not edit by hand.
...
function glyph(name) { return map[name] || "" }
function has(name) { return map[name] !== undefined }
